...
var samples_clothing_orders = function(server) {
	return {
        save_sample_order : function(order, cb) {
			var query = `insert into samples_clothing_orders (id, order_id, origin_order_id, store_id, person_id,
        ...
        //获取所有订单根据用户
        search_samples_orders_by_person:  function(person_id, cb){
...
module.exports = samples_clothing_orders;
