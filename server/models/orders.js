...
var orders = function(server) {
	return {
		...
		save_orders : function(order_id,vip_id,actual_price,marketing_price,pos_id,operation_system,origin,pay_way,store_id,small_change, cb) {
			...
			total_price, actual_price, order_date, order_status, operation_system, origin, pos_id, pay_way,store_id,small_change,
			...
			now(),now(),0)` ;
			console.log(query);
			var columns=[order_id,vip_id, marketing_price, marketing_price-actual_price, marketing_price,actual_price,operation_system,origin,pos_id,pay_way,store_id,small_change];
